...
<script type="text/javascript">
    ...
    layui.use([ 'jquery', 'layer', 'form', 'table'  ], function() {
        ...
        tableIns=table.render({
            ...
            ,url:'${whContextPath}/customer/loadAllCustomer' //数据接口
        ...
        $("#doSearch").click(function(){
            ...
            tableIns.reload({
                url:"${whContextPath}/customer/loadAllCustomer?"+params ,
                page:{
                    curr:1
                }
            })
        ...
        table.on('tool(customerTable)', function(obj){
            ...
            if(layEvent === 'del'){ //删除
                layer.confirm('真的删除【'+data.custname+'】这个客户吗', function(index){
                    //向服务端发送删除指令
                    $.post("${whContextPath}/customer/deleteCustomer",{identity:data.identity},function(res){
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
        ...
        function openAddCustomer(){
            mainIndex=layer.open({
                ...
                success:function(index){
                    //清空表单数据       
                    $("#dataFrm")[0].reset();
                    url="${whContextPath}/customer/addCustomer";
                }
            });
        }
        //打开修改页面
        function openUpdateCustomer(data){
            mainIndex=layer.open({
                ...
                success:function(index){
                    ...
                    url="${whContextPath}/customer/updateCustomer";
                }
            });
        }
        //保存
        ...
        function deleteBatch(){
            ...
            layer.confirm('真的删除选中的这些客户吗', function(index){
                //向服务端发送删除指令
                $.post("${whContextPath}/customer/deleteBatchCustomer",params,function(res){
                    layer.msg(res.msg);
                    //刷新数据 表格
                    tableIns.reload();
                })
