...
<script type="text/javascript">
    ...
    layui.use([ 'jquery', 'layer', 'form', 'table','laydate'  ], function() {
        ...
        tableIns=table.render({
            ...
            ,url:'${whContextPath}/rent/loadAllRent' //数据接口
        ...
        $("#doSearch").click(function(){
            ...
            tableIns.reload({
                url:"${whContextPath}/rent/loadAllRent?"+params ,
                page:{
                    curr:1
                }
            })
        ...
        table.on('tool(rentTable)', function(obj){
            ...
            if(layEvent === 'del'){ //删除
                layer.confirm('真的删除【'+data.rentid+'】这个出租单吗', function(index){
                    //向服务端发送删除指令
                    $.post("${whContextPath}/rent/deleteRent",{rentid:data.rentid},function(res){
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
        ...
        function openUpdateRent(data){
            mainIndex=layer.open({
                ...
                success:function(index){
                    ...
                    url="${whContextPath}/rent/updateRent";
                }
            });
        }
        //保存
