...
<div class="layui-layout layui-layout-admin">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img
                            src="${pageContext.request.contextPath}/resources/images/wlyLogo.png"
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="${pageContext.request.contextPath}/resources/images/wlyLogo.png"
                                             class="userAvatar"></a>
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;"
                       data-url="${pageContext.request.contextPath}/resources/page/main.html"><i
                            class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
                </li>
            </ul>
        </div>
    </div>
